...
<header class="header flex flex-row items-center">
  ...
  <form class="bg-white w-2/3  shadow-md rounded p-10 mb-4" method="POST" action="{{ route('post.image')}}">
    @csrf
    <div class="mb-4">
    ...
    <div class="mb-6">
      ...
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" name="description" id="description" type="text" placeholder="Description">
    </div>
    <div class="mb-6">
      <label class="block text-gray-700 text-s font-bold mb-2" for="picture">
        Profil picture
      </label>
      <input class="" id="picture" name="picture" type="file" placeholder="picture">
    </div>
    <div class="mb-6">
      <label class="block text-gray-700 text-s font-bold mb-2" for="userId">
        UserID      </label>
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" name="userId" id="userId" type="number" placeholder="userId">
    </div>
